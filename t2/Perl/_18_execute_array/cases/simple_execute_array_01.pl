...
$sth->bind_param_array(1, [ 'John', 'Mary', 'Tim' ]) or die "bind_param_array error: $dbh->errstr";
$sth->bind_param_array(2, [ 'Booth', 'Todd', 'Robinson' ]) or die "bind_param_array error: $dbh->errstr";
