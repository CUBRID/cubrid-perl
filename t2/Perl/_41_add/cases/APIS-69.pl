...
$dbh -> do("create table coo(col4 bit(8),col10 float,col11 double,col12 date,col13 time,col14 timestamp);") or die "create error: $dbh->errstr";

$dbh->do("insert into coo values(b'0011', 10,11, '1/1/2008', '1:1:1 pm', '01/31/1994 8:15:00 pm');") or die "insert error:  $dbh->errstr";
