...
echo "###start simple_getinfo_01.pl "  >getinfo.result
version=`perldoc -m  DBD::cubrid | grep "VERSION ="`
version=${version#*\'}
version=${version%%\'*}
perl simple_getinfo_01.pl $db $port $localhost $version >>getinfo.result
