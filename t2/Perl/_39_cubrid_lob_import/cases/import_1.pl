...
my $importValue=$sth->cubrid_lob_import (2, "$cwd/import1.txt", DBI::SQL_BLOB) or die   $dbh->errstr . "  cubrid_lob_import error\n";
$sth->execute();
like($dbh->errstr,qr/Cannot coerce host var to type clob/,"execute error\n");
